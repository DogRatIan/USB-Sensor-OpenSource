...
Public Class FormMain
    ...
    Dim gChartPressure As Array = Array.CreateInstance(GetType(Double), 60)
    ...
    Private Sub UpdateEditBox()
        ...
        REM Update Pressure
        If gCurrPressure = Double.NaN Then
            Me.BarPressure.Value = 0
            str_pressure = ""
        Else
            If gCurrPressure < Me.BarPressure.Minimum Then
                Me.BarPressure.ForeColor = Color.Aqua
                Me.BarPressure.Value = Me.BarPressure.Minimum
            ElseIf gCurrPressure > Me.BarPressure.Maximum Then
                Me.BarPressure.ForeColor = Color.Red
                Me.BarPressure.Value = Me.BarPressure.Maximum
            Else
                Me.BarPressure.ForeColor = Color.RoyalBlue
                Me.BarPressure.Value = gCurrPressure
            End If

            str_pressure = String.Format("{0:F1} Pa", gCurrPressure)
        End If
        Me.BarPressure.Refresh()
        Me.EditPressure.Text = str_pressure
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Chart3.DataBindTable(gChartPressure)
        Me.Chart3.Series(0).ChartType = 4
        Me.Chart3.ChartAreas(0).AxisY.Maximum = 110000
        Me.Chart3.ChartAreas(0).AxisY.Minimum = 60000
    ...
    Private Function GetPressure(ByVal portName As String) As Double
        Dim str_pressure As String
        Dim ret As Double = Double.NaN
        ...
        Try
            ...
            REM Get Temperature
            Me.SerialPort.ReadExisting()
            Me.SerialPort.Write("GP" + vbCr)
            str_pressure = CleanUpString(Me.SerialPort.ReadLine)
            ret = str_pressure
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        gCurrPressure = GetPressure(Me.ComboBoxPort.Text)
        ...
        For i = 0 To (len - 2)
            ...
            gChartPressure(i) = gChartPressure(i + 1)
        Next i
        gChartTemp(len - 1) = gCurrTemp
        gChartHumi(len - 1) = gCurrHumi
        gChartPressure(len - 1) = gCurrPressure
