...
// Constants
//==========================================================================
static const struct TBaudTable KBaudTable[] = {{"1200", B1200, 1200},
                                               {"2400", B2400, 2400},
                                               {"4800", B4800, 4800},
                                               {"9600", B9600, 9600},
                                               {"14400", 14400, 14400},
...
static const struct TModeTable KModeTable[] = {{"N81", CS8},
                                               {"E81", CS8 | PARENB},
...
//==========================================================================
const char *CSerial::SearchCfg(const char *aCfg, const char *aStr) { return strstr(aCfg, aStr); }
...
int CSerial::Read(unsigned char *aDest, int aDestLen) {
  if (ComFid == INVALID_HANDLE_VALUE) return -1;
