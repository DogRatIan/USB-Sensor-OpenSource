...
// Gen Date string
//==========================================================================
static const char *KStrMonth[12] = {"JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC"};
...
void GenDateString(char *aDest, time_t aTimeStamp, int aLen, int aLong = false) {
  ...
  if (aLong)
    snprintf(aDest, aLen, "%s-%02d-%04d %02d:%02d:%02d", KStrMonth[tm.tm_mon], tm.tm_mday, tm.tm_year + 1900, tm.tm_hour, tm.tm_min,
             tm.tm_sec);
  else
