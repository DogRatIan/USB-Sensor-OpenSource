...
Component.prototype.createOperations = function()
{
    try {
        ...
        if (systemInfo.productType === "windows") {
            component.addOperation ("CreateShortcut", "@TargetDir@/bin/USB-Sensor_Desktop.exe", "@StartMenuDir@/USB-Sensor_Desktop.lnk",
...
Component.prototype.dynamicPageEntered = function ()
{
    ...
    if (pageWidget != null) {
        ...
        pageWidget.textContent.setText ("<b>USB-Sensor (Desktop)</b> is a application for DogRatIan USB Sensors.<br>"
         + "<br>"
